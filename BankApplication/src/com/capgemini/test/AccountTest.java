...
public class AccountTest {
	 ...
	 * 2. if the account number is valid then system should deposit amount
	 * 
	 */
	
	@Test
	public void whenTheAccountNumberIsInvaidThenSystemShouldThrowException() throws InvalidAccountNumberException
	{
		Account account = new Account();
		account.setAccountNumber(101);
